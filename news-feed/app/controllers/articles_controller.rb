class ArticlesController < ApplicationController 
  ...
  def create
    @article = current_user.articles.new(article_params)
      ...
      @article.title = doc.at_css("title").text
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:title, :link, :user_id)
    end
    
    
    def correct_user
       @article = current_user.articles.find_by(id: params[:id])
       redirect_to articles_path, notice: "Not authorized to perform this action" if @article.nil?
    end
